# Промпт для Claude Code: деплой агента «Юрист первой линии (redline договоров)» в ASCN

Скопируй текст ниже в Claude Code, запущенный в этой папке (03-contract-redline-published/).

---

Ты переносишь готового агента «Юрист первой линии (redline договоров)» на платформу ASCN (ascn.ai).
