...
4. Do NOT create automations yourself: the agent creates them during onboarding, reading workspace/AUTOMATIONS.md (Morning ops briefing, PR and check watch, Weekly ops digest), only if the user agrees.
