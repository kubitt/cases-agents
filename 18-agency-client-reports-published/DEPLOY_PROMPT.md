# Промпт для Claude Code: деплой агента «Мульти-клиент отчёты для агентств» в ASCN

Скопируй текст ниже в Claude Code, запущенный в этой папке (18-agency-client-reports-published/).

---

Ты переносишь готового агента «Мульти-клиент отчёты для агентств» на платформу ASCN (ascn.ai).
