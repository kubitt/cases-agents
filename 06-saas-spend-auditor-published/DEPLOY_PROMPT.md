# Промпт для Claude Code: деплой агента «SaaS-аудитор расходов» в ASCN

Скопируй текст ниже в Claude Code, запущенный в этой папке (06-saas-spend-auditor-published/).

---

Ты переносишь готового агента «SaaS-аудитор расходов» на платформу ASCN (ascn.ai).
...
2. Перенеси в воркспейс агента ASCN:
   ...
   - workspace/skills/subscription-hunt/SKILL.md → /data/workspace/skills/subscription-hunt/SKILL.md
   - workspace/skills/renewal-verdict/SKILL.md → /data/workspace/skills/renewal-verdict/SKILL.md
   - workspace/knowledge/AUDIT_SCHEMA.md → /data/workspace/knowledge/AUDIT_SCHEMA.md
   - workspace/knowledge/NEGOTIATION_TEMPLATES.md → /data/workspace/knowledge/NEGOTIATION_TEMPLATES.md
...
6. Отправь агенту первое сообщение «Привет, начнём настройку» и убедись, что он начал онбординг по шагам (представился, назвал время настройки ~10 минут, задал первый вопрос — подключение Gmail).
