...
4. Do NOT create automations yourself: the agent creates the two crons during onboarding (Overnight build 02:00, Morning delivery 08:00), reading workspace/AUTOMATIONS.md.
